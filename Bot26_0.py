...
class Fleet:
    ...
    def findTarget(self, startHalite, start, maxDis = 10):
        ...
        while toSearch:
            ...
            if self.command.game_map.calculateDistance(pos, start) < maxDis and newHalite < RETURN_T:
                for dir in Direction.get_all_cardinals():
                    newPos = self.command.game_map.normalize(pos.get_directional_offset(dir))
